defmodule PhoenixStorybookDemo do
  @moduledoc """
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/phoenix_storybook_demo/templates",
        namespace: PhoenixStorybookDemo
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {PhoenixStorybookDemo.LayoutView, :live}
  ...
  def channel do
    quote do
      use Phoenix.Channel
      import PhoenixStorybookDemo.Gettext
    end
  end
