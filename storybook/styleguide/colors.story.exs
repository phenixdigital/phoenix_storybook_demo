...
defmodule Storybook.Colors.Primary do
  def info do
    %{
      ...
      description:
        "Primary application Color. should be used for main actions, highlights and titles."
    }
  end
...
defmodule Storybook.Colors.Danger do
  def info do
    %{
      ...
      description:
        "Danger color should be used to report errors or to present destructive actions. "
    }
  end
